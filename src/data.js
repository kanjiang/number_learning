...
export const numberCards = [
  { value: 1, label: '数字 1', image: withBase('/assets/images/numbers/IMG_18731.jpg'), tip: '找一找图片里的数字 1，并大声读出来。', audioTextZh: '1', audioTextEn: 'one', mnemonic: '1 像画笔去画画', mnemonicAudioZh: withBase('/assets/audio/mnemonic/1.wav'), audioZh: withBase('/assets/audio/zh/1.wav'), audioEn: withBase('/assets/audio/en/1.wav') },
  { value: 2, label: '数字 2', image: withBase('/assets/images/numbers/IMG_18732.jpg'), tip: '看看数字 2 藏在哪里，点一下试试看。', audioTextZh: '2', audioTextEn: 'two', mnemonic: '2 像鸭子水中游', mnemonicAudioZh: withBase('/assets/audio/mnemonic/2.wav'), audioZh: withBase('/assets/audio/zh/2.wav'), audioEn: withBase('/assets/audio/en/2.wav') },
  { value: 3, label: '数字 3', image: withBase('/assets/images/numbers/IMG_18733.jpg'), tip: '找到数字 3 后，可以点开学习提示。', audioTextZh: '3', audioTextEn: 'three', mnemonic: '3 像耳朵听声音', mnemonicAudioZh: withBase('/assets/audio/mnemonic/3.wav'), audioZh: withBase('/assets/audio/zh/3.wav'), audioEn: withBase('/assets/audio/en/3.wav') },
  { value: 4, label: '数字 4', image: withBase('/assets/images/numbers/IMG_18734.jpg'), tip: '和小朋友一起数一数，看看数字 4。', audioTextZh: '4', audioTextEn: 'four', mnemonic: '4 像旗子风中飘', mnemonicAudioZh: withBase('/assets/audio/mnemonic/4.wav'), audioZh: withBase('/assets/audio/zh/4.wav'), audioEn: withBase('/assets/audio/en/4.wav') },
  { value: 5, label: '数字 5', image: withBase('/assets/images/numbers/IMG_18735.jpg'), tip: '点击图片中的互动点，认识数字 5。', audioTextZh: '5', audioTextEn: 'five', mnemonic: '5 像秤钩称重量', mnemonicAudioZh: withBase('/assets/audio/mnemonic/5.wav'), audioZh: withBase('/assets/audio/zh/5.wav'), audioEn: withBase('/assets/audio/en/5.wav') },
  { value: 6, label: '数字 6', image: withBase('/assets/images/numbers/IMG_18736.jpg'), tip: '读一读数字 6，再点音频按钮。', audioTextZh: '6', audioTextEn: 'six', mnemonic: '6 像哨子吹的响', mnemonicAudioZh: withBase('/assets/audio/mnemonic/6.wav'), audioZh: withBase('/assets/audio/zh/6.wav'), audioEn: withBase('/assets/audio/en/6.wav') },
  { value: 7, label: '数字 7', image: withBase('/assets/images/numbers/IMG_18737.jpg'), tip: '从图片里把数字 7 找出来。', audioTextZh: '7', audioTextEn: 'seven', mnemonic: '7 像镰刀挖小草', mnemonicAudioZh: withBase('/assets/audio/mnemonic/7.wav'), audioZh: withBase('/assets/audio/zh/7.wav'), audioEn: withBase('/assets/audio/en/7.wav') },
  { value: 8, label: '数字 8', image: withBase('/assets/images/numbers/IMG_18738.jpg'), tip: '观察图片内容，学习数字 8。', audioTextZh: '8', audioTextEn: 'eight', mnemonic: '8 像麻花缠一起', mnemonicAudioZh: withBase('/assets/audio/mnemonic/8.wav'), audioZh: withBase('/assets/audio/zh/8.wav'), audioEn: withBase('/assets/audio/en/8.wav') },
  { value: 9, label: '数字 9', image: withBase('/assets/images/numbers/IMG_18739.jpg'), tip: '点击热点查看数字 9 的学习提示。', audioTextZh: '9', audioTextEn: 'nine', mnemonic: '9 像蝌蚪找妈妈', mnemonicAudioZh: withBase('/assets/audio/mnemonic/9.wav'), audioZh: withBase('/assets/audio/zh/9.wav'), audioEn: withBase('/assets/audio/en/9.wav') },
  { value: 10, label: '数字 10', image: withBase('/assets/images/numbers/IMG_18740.jpg'), tip: '最后认识数字 10，完成一轮练习。', audioTextZh: '10', audioTextEn: 'ten', mnemonic: '10 是一和零手拉手', mnemonicAudioZh: withBase('/assets/audio/mnemonic/10.wav'), audioZh: withBase('/assets/audio/zh/10.wav'), audioEn: withBase('/assets/audio/en/10.wav') }
].map((card) => ({
  ...card,
